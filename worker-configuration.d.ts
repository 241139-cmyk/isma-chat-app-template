export default {
  async fetch(request, env) {
    ...
    if (request.method !== "POST") {
      return new Response(
        JSON.stringify({
          error: "Use POST request with JSON body.",
        }),
        {
    ...
    try {
      // Parse incoming JSON
      const { prompt, type = "chat" } = await request.json();
      ...
      // =========================
      if (type === "image") {
        // Requires AI binding named "AI" in wrangler.jsonc
        // Example:
        // {
        //   "ai": {
        //     "binding": "AI"
        ...
        // Return generated image directly
